...
//The users general knowledge is tested with quiz questions regarding science, technology, Computer science, sports,
...
int main()//Start of main function.
     ...
     printf("\n\n\t\t   Become A MILLIONAIRE. Let's Start !!!!!    ") ;
     printf("\n\t\t$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to participate Quiz Game --------------------------",playername);
    printf("\n\n Here you get some tips, that might be helpful for you.");
    printf("\n -------------------------------------------------------------------------");
    ...
    system("cls");
     ...
     switch(r1)
		...
		if (toupper(getch())=='C')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.12121");
		           getch();
		       break;
		       }

        case 2:
		printf("\n\n\nWhich is the best progamming language for Data Science?  ");
		printf("\n\nA.c\t\tB.Ruby\n\nC.Python\tD.Scala");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C.Python");
		       getch();
		       break;}
        ...
        case 6:
		printf("\n\n\nWhich language is not server side programming language? ");
		printf("\n\nA.Python\t\tB.PHP\n\nC.C++\t\tD.HTML");
		if (toupper(getch())=='D' )
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is D.HTML");
		       getch();
		       break;}}
		       }
...
game:
     ...
     switch(r)
		...
		printf("\n\nA.Object code\t\tB.Assembly code\n\nC.Executable code\tD.None of them");
		if (toupper(getch())=='A')
			  {printf("\n\nCorrect!!!");countr++;getch();
			   break;}
		else
              {printf("\n\nWrong!!! The correct answer is A.Object code");getch();
              goto score;
              break;
              }
		...
		printf("\n\nA.MOSAIC\t\tB.WWW\n\nC.Netscape navigator\tD.Facebook");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is D.Facebook");getch();
		       goto score;
		       break;}
		...
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch(); break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is A.Malware");getch();break;goto score;}
		...
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C.Double");getch();
		       break;goto score;}
